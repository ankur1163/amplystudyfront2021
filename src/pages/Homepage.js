					...
					<Grid container spacing={4} direction="row" justify="space-around" alignItems="center">
						...
						<Grid item align="center" container direction="column" sm={7}>
							<Grid item>
                                ...
                                Join Amplyation outsourcing LLP as apprentice. Start getting salary and learn while working for real clients. 
								</Typography>
							</Grid>
						</Grid>
					</Grid>
					...
					<Grid container spacing={4} direction="row" justify="space-around" alignItems="center">
						...
						<Grid item align="center" container direction="column" sm={7}>
							<Grid item>
                                ...
                                After an apprenticeship of few months, you will handle multiple clients under dedicated manager. 
								</Typography>
							</Grid>
						</Grid>
					</Grid>
					...
					<Grid container spacing={4} direction="row" justify="space-around" alignItems="center">
						...
						<Grid item align="center" container direction="column" sm={7}>
							<Grid item>
								...
								<Typography align="center" variant="h5">
                                After few months working as virtual assistant, you will be promoted as dedicated manager. 
								</Typography>
							</Grid>
						</Grid>
					</Grid>
					...
					<Grid container spacing={4} direction="row" justify="space-around" alignItems="center">
						...
						<Grid item align="center" container direction="column" sm={7}>
							<Grid item>
								...
								<Typography align="center" variant="h5">
                                After few months working as dedicated manager, you will be promoted as senior manager. 
								</Typography>
							</Grid>
						</Grid>
					</Grid>
					...
					<Grid container spacing={4} direction="row" justify="space-around" alignItems="center">
						...
						<Grid item align="center" container direction="column" sm={7}>
							<Grid item>
								...
								<Typography align="center" variant="h5">
                                After few months working as Dedicated Manager, you can start your own company/find job in other company or continue with us. 
								</Typography>
							</Grid>
						</Grid>
					</Grid>
              ...
              <Box pt={2} pb={2} align="center">
                ...
                <Grid container align="center" direction="row">
                    <Grid item container sm={4}  direction="column">
                        ...
                        Light, you are creating a revolution here. Guys, dont wait, just join the course. — Ajeeth
                        </Typography>
                    ...
                    <Grid item>
                       <img alt="testimonial" src={testimonial3}/>
                        ...
                        <Grid item>
                        <Typography align="center" variant="body1">
                        I wasted so much money in network marketing, I am finally earning good money. — Priyanka
                        </Typography>
               ...
               {/* know visinary starts   */}
                    <Grid  style={{marginTop:"20px" }} container direction="row" justify="space-between" align="center" >
                        <Grid item sm={6}>
                            <img width="321px" height="478px" alt="light image" src={light1}/>

                        </Grid>
                        <Grid item sm={6}>
                            <Typography variant="h2">
                            Know the Visionary behind this new world 
                            </Typography>
                        <Typography  variant="body1" >
                        
My name is Light and for the past 12 years, I have been working from home. I am the founder of Amplyation outsourcing LLP.  
I am on a mission. I truly believe, the world will change in the next 10 years and only, those will survive who knows 
the art of working from home. I am here to guide you on how to make money online and How to make it a fruitful career.
                        </Typography>
			   ...
			   <Grid container justify="space-around" direction="row">
				   <Grid item container align="center" sm={3} direction="column" >
				   ...
				   <Grid item container align="center" sm={3} direction="column" >
					...
					<Grid item container align="center"  sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							But want to earn some extra side money
							</Typography>
				   ...
				   <Grid item container align="center" sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							World thinks its impossible to create 100% virtual company. Where everyone works from home. Work with us and lets change the world
							</Typography>
					...
					<Grid item container align="center"  sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							Some of us hate big cities and want to enjoy simple city life. This is perfect for them
							</Typography>
					...
					<Grid item container align="center"  sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							Those who want to travel all around the world. Once, you learn how to work/make money online. You can travel all around the world.
							</Typography>
				   ...
				   <Grid item container align="center" sm={3} direction="column" >
					...
					<Grid item container align="center"  sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							99% of your clients will be from Europe, USA, Canada or other western countries. You will earn in $$
							</Typography>
					...
					<Grid item container align="center"  sm={3} direction="column" >
					   ...
					   <Grid item>
					        <Typography variant="body1">
							Most westerners respect your personal life. You will have saturday sunday off and no one will bother you after 8 hours of your work shift. 
							</Typography>
				...
				>
					<Grid item align="center">
						<Typography  variant="h2">
						Offer- Rs 4999 (one time for full course)


						</Typography>
						<Typography  variant="h5">
						Contact us at 6280086334 
						</Typography>
						<Typography  variant="h5">
						for more EMI payment info and
						</Typography>
						<Typography  variant="h5">
						discount coupons
						</Typography>
				...
				<Accordion>
					...
					<AccordionDetails>
					<Typography>
					Scroll above and click buy now button
					</Typography>
					</AccordionDetails>
				</Accordion>
				<Accordion>
				...
				<Accordion>
					...
					<AccordionDetails>
					<Typography>
					Please drop us email at support@amplyation.com
					</Typography>
					</AccordionDetails>
				</Accordion>
